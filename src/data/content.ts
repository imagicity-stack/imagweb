export const services = [
  {
    ...
    icon: "🧭",
    accent: "from-orange-400/60 to-white/10"
  },
  {
    ...
    icon: "🚀",
    accent: "from-orange-300/70 via-rose-200/25 to-transparent"
  },
  {
    ...
    icon: "🧩",
    accent: "from-rose-400/60 via-orange-200/30 to-white/5"
  },
  {
    title: "Web & Funnel",
    ...
    icon: "💻",
    accent: "from-amber-300/80 via-rose-100/20 to-transparent"
  }
];
...
export const timeline = [
  {
    year: "2018",
    title: "Agency sparks",
    copy: "Born as a distributed collective of strategists and artists obsessed with momentum.",
    pin: "Origin"
  },
  {
    year: "2020",
    title: "Global sprints",
    copy: "Launched 40+ campaigns in gaming, fintech, and luxury with remote-first production.",
    pin: "Scale"
  },
  {
    year: "2022",
...
export const team = [
  {
    name: "Nova Kim",
    role: "GTM Architect",
    focus: "Positioning, growth loops, funnels",
    avatar: "N",
    glow: "from-orange-400 via-rose-200/30 to-transparent"
  },
  {
    name: "Ari Vega",
    role: "Design Director",
    focus: "Visual systems, motion direction",
    avatar: "A",
    glow: "from-white via-orange-200/40 to-transparent"
  },
  {
    name: "Milo Carter",
    role: "Lead Engineer",
    focus: "Next.js, GSAP, performance",
    avatar: "M",
    glow: "from-rose-500 via-orange-200/30 to-transparent"
  }
];
...
export const projects = [
  {
    ...
    palette: "from-orange-400/60 via-rose-200/25 to-transparent",
  ...
  },
  {
    ...
    palette: "from-white/60 via-orange-200/35 to-transparent",
  ...
  },
  {
    ...
    palette: "from-rose-500/45 via-orange-200/25 to-transparent",
